...
The string str consists of binary digits eparated with an
alphabet as follows:
...
1
Explanation:
The alphabets in str when expanded becomes
“1 XOR 0 XOR 1 XOR 1 AND 0 OR 1”, result of the expression becomes 1, hence 1 is returned.
